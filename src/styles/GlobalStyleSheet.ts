...
export const styles = StyleSheet.create({
  ...
  rankBadge: {
    backgroundColor: "rgba(0, 229, 155, 0.2)",
  ...
  vsTeamName: { fontSize: 20, fontWeight: "900", textTransform: "uppercase" },
  vsLabel: { color: THEME.textDim, fontSize: 12 },
  vsText: {
    color: THEME.text,
    fontSize: 24,
    fontWeight: "900",
  ...
  matchName: { fontSize: 18, fontWeight: "bold", marginBottom: 4 },
  matchSub: { color: THEME.textDim, fontSize: 12 },
  ...
  outlineBtnText: { color: THEME.primary, fontWeight: "bold" },
